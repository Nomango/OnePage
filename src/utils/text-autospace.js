...
export { genTextSpace, autoGenTextSpace }

var autoGenTextSpace = ((selector) => {
  $(() => {
    const targetNode = $(selector)[0];
    const config = { attributes: false, childList: true, subtree: false };
    const callback = () => genTextSpace();
...
/**
 * genTextSpace
 * @link https://github.com/mastermay/text-autospace.js
 * @author mastermay javismay@gmail.com
 * @license http://unlicense.org/UNLICENSE
 */
$(() => genTextSpace());

var genTextSpace = (function (window, $) {
  let init = function () {
    $('body').each(function () {
      var hanzi = '[\u2E80-\u2FFF\u31C0-\u31EF\u3300-\u4DBF\u4E00-\u9FFF\uF900-\uFAFF\uFE30-\uFE4F]',
        punc = {
