      ...
      items: [
        {
          ...
          description: [
            ...
            <><Title text="技术贡献" />：完成了技术选型、系统架构设计、核心业务代码编写、DevOps 的搭建及维护等；此次创业经历使我对<b>微服务架构</b>的各个方面如服务划分、服务集成、安全、监控、高可用等都有了更加全面的认识；</>,
            <><Title text="团队建设" />：组织并带领小型技术团队开展研发工作，包括研发规范的制定及落实、需求分析与技术方案制定、产研人效提升等，成功帮助公司打造了一个<b>敏捷团队</b>。</>,
