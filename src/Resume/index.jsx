...
const Resume = {
  ...
  sections: [
    ...
    // },
    {
      ...
      items: [
        {
          name: <>成都航诺莱百科技有限公司（创业）</>,
          duration: "2022/06 - 至今",
          position: "技术合伙人",
          description: [
            <><Title text="主要工作" />：担任<b>技术负责人</b>合伙创办该公司，负责包括从0到1的技术团队组建、系统架构设计、产品方向与定位思考、辅助推广运营等等，帮助公司<b>从0成长到15w+</b>用户量，稳定运行容器实验<b>30w+</b>次；</>,
            <><Title text="团队建设" />：组织并带领 3 人技术团队开展研发工作，包括研发规范的制定及落实、需求分析与技术方案制定、产研人效提升等；团队虽小但每个人都是有大厂背景的佼佼者，成功帮助公司打造了一个<b>敏捷团队</b>；</>,
            <><Title text="技术贡献" />：完成了技术选型、系统架构设计、核心业务代码编写，基础设施和开发框架的搭建及维护等；此次创业经历使我对<b>微服务架构</b>的各个方面如服务划分、服务集成、安全、监控、高可用等都有了更加全面的认识。</>,
            // <><Title text="工作内容" />：作为<b>技术负责人</b>完成 LabEx（海外 IT 教育）和 GetVM（云桌面浏览器插件） 两个云产品。</>,
            // [
            //   <>人效提升：广泛借助 AI 等工具提升运营人效，如通过 AI 生成格式化教程内容及实时课程封面、通过在线文档制作仪表盘同步管理运营资源、服务上线通知到群等；</>,
        ...
        },
        {
          ...
          description: [
            <><Title text="工作内容" />：负责广告审核的核心业务开发工作，先后参与了关联图谱、模型迭代平台、风控规则平台等多个平台的研发，逐步从只实现业务功能成长为可以<b>参与系统设计</b>的一员，可以独自完成服务设计与开发、应对系统突发流量等紧急情况等等；</>,
            <><Title text="荣誉奖项" />：在职期间持续保持 <b>绩效优异</b>，并于2022年4月获得<b>Spot Bonus</b> - 超出预期成果奖项；</>,
            <><Title text="自我约束" />：工作之余完成个人负责项目40% ~ 60%的单测覆盖率，同时建设了多个基础组件。</>,
            // <><Title text="主要产出" />：</>,
            // [
